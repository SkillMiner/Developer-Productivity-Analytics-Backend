...
import com.dpa.backend.github.entities.GithubResponseData;
import com.dpa.backend.github.entities.GithubUser;
import com.dpa.backend.github.querymodels.DateRange;
import com.dpa.backend.github.querymodels.DateRangeWithUserName;
import com.dpa.backend.github.querymodels.GraphqlQuery;
...
public class GithubGraphqlClient {
    ...
    private Map<String, String> clientParams() {
        ...
        params.put("client_id", appProperties.getGithubClientId());
        params.put("client_secret", appProperties.getGithubClientSecret());
        return params;
    }
